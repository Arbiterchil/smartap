 ...
 */
public class aasign extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        z= inflater.inflate(R.layout.fragment_aasign, container, false);
        ...
        dates = z.findViewById(R.id.datetoday);
        spiname = z.findViewById(R.id.namestudes);
        SaveGrade = z.findViewById(R.id.saves);
        spin = z.findViewById(R.id.namestud);
        inputgrade = z.findViewById(R.id.input);
            ...
            public void onClick(View v) {
                ...
                reff.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        reff.child("AssignmentRecords").child(key).child(keys).setValue(input);
