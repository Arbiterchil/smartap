 ...
 */
public class exalab extends Fragment {
    View b;
    TextView datetoday;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        b = inflater.inflate(R.layout.fragment_exalab, container, false);
    ...
    private void SaveThatDog() {
        ...
        savingu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reff.child("ComLabExamRecords").child(key).child(keys).setValue(input);
